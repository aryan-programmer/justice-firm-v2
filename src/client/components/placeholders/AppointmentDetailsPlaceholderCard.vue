...
<template>
<v-card color="white" class="w-100 elevation-3">
	<v-card-title>
	...
	<v-card-text>
		...
		<ContentLoader
			:width="400"
			:viewBox="`0 0 400 ${contentLoaderTextHeightWithPadding*5}`"
	...
	<v-card-actions>
		<ButtonPlaceholder v-for="i in 3" :height="36" :width="145" class="ms-3" />
	</v-card-actions>
</v-card>
</template>
